...
DUBLIN_COORDINATES = {"latitude": 37.7021, "longitude": -121.9358}

# Calculate movement increments
LATITUDE_INCREMENT = (DUBLIN_COORDINATES['latitude'] - SAN_FRANCISCO_COORDINATES['latitude']) / 100
LONGITUDE_INCREMENT = (DUBLIN_COORDINATES['longitude'] - SAN_FRANCISCO_COORDINATES['longitude']) / 100
...
if __name__ == "__main__":
    ...
    try:
        simulate_journey(producer, 'Vehicle-CodeWithGeorge-123')
